 ...
 */
public class SessionLogHourJob implements Tool {
	...
	private static final Log LOG = LogFactory.getLog(SessionLogHourJob.class);

	public static void main(String[] args) throws Exception {

		int returnStatus = 0;
		SessionLogHourJob job = new SessionLogHourJob();
			...
			if (parts == null || parts.length == 0)
				...
				for (String part : parts) {
					...
					// yyyy/mm/dd/hh
						...
						if (part.startsWith("/deliverlog") || part.startsWith("/clicklog")) {
